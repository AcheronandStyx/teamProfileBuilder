...
const { managerQuery, createEmployee, confirmAddMember, createNonManger } = require('../utils/prompts.js');
...
class Team {
    ...
    buildTeam() {
        ...
        const managerQueries = createEmployee.concat(managerQuery); // copies array exactly?
    ...
    static addNewMember() {
        const employeeQueries = confirmAddMember.concat(createEmployee).concat(createNonManger);
